...
import 'package:study_app/features/sign_in/forget/forget_logic.dart';
...
class ForgetPage extends ConsumerStatefulWidget {
  ...
  static Route<void> route() {
    return MaterialPageRoute<void>(builder: (_) => ForgetPage());
  }

  @override
  ConsumerState<ForgetPage> createState() => _ForgetPage();
}

class _ForgetPage extends ConsumerState<ForgetPage> {
